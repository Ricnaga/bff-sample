...
export const MICROSERVICE_SAMPLE_USER_ENDPOINT = `${MICROSERVICE_SAMPLE_SAMPLE_ENDPOINT}_user`;
export const MICROSERVICE_SAMPLE_USER_BYID_ENDPOINT = `${MICROSERVICE_SAMPLE_USER_ENDPOINT}/:id`;
